      ...
      <div id="BusList" class="w-full">
        ...
        <div class="flex flex-col gap-4 w-full">
          <div class="w-full  " v-for="route in matchedRoutes" :key="route">
            ...
            <div v-else class="flex flex-col md:flex-row bg-gray-100 py-4 md:py-6 px-6 md:px-10 rounded-md">
              <div class="w-full md:w-1/3 flex flex-col justify-between">
                <div class="my-2">
                ...
                <div class="my-2">
                  <p class="text-xl font-bold text-metoPrimary-900">
                    {{
                      ...
                      <p class="text-metoPrimary-800 text-sm">
                        (Seats Available)
                      </p>
                </div>
                ...
                <div>
                  <button class="
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                      x="0px" y="0px" class="h-4 md:h-6 w-auto fill-current" viewBox="0 0 31.93 31.93"
