...
export async function getCancelledRoutesBySubRouteDate(subRouteId,date){
    return await axios.get(`${devUrl}/cancelled-route-date/subroute-dateId/${subRouteId}/${date}`) 
}
