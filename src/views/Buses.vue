        ...
        <div id="BusList" class="w-full">
          ...
          <div class="flex flex-col gap-4 w-full">
            <div
              ...
              :key="route"
            >
              <div v-if="route.isCancelled" class="flex flex-col md:flex-row bg-gray-50 py-4 md:py-6 px-6 md:px-10 rounded-md">
                ...
                <div class="w-full md:w-1/3 flex flex-col justify-between">
                  <p
                    class="text-xl font-bold text-metoPrimary-300 line-through"
                  >
                    Nu.{{ route.fare }}
                  </p>
              ...
              <div v-else class="flex flex-col md:flex-row bg-gray-100 py-4 md:py-6 px-6 md:px-10 rounded-md">
                ...
                <div
                  class="flex flex-col gap-4 w-full md:w-1/3 justify-between"
                >
                  <div>
                    <button
                      class="
                  ...
                  <div v-if="route.parentRouteId">
                    <p
                      class="text-xs md:text-xl font-bold text-metoPrimary-900"
                    >
                      *SubRoute
                    </p>
                    <p class="text-metoPrimary-800 text-xs md:text-sm">
