<template>
  <div>
    <main
      ...
      "
    >
      <h1 class="text-3xl font-bold text-gray-800">Refund Policy</h1>

      <p>
        <span class="text-gray-800 font-semibold text-xl">
          Its okay to change your mind.</span
        >
        We understand that you may need to cancel the ticket in case of
        unavoidable circumstances and it is perfectly fine. To make it
        convenient for you and us the service provider following points cover
        our refund policy:
      </p>
      ...
      <ul class="">
        <li class="m-1">
          ...
          <span class="text-gray-800 font-semibold text-xl"
            >cancel the ticket two hours before departure</span
          >
          and the company will facilitate the full refund of the ticket.
        </li>
        <li class="m-1">
          2) The refund may
          <span class="text-gray-800 font-semibold text-xl">
          ...
          depending on the volume of cancellation requests.
        </li>
        <li class="m-1">
          3) A SMS notification will be sent upon successful refund to ensure
          that you get a confirmation that your money has been refunded.
        </li>
        <li class="m-1">
          4) During cancellation following details will be collected:
          <ul class="ml-5">
        ...
        <li class="m-1">
          7) You will be asked to agree to our privacy and refund policy and to
          check the correctness of the information entered.
        </li>
        <li class="m-1">
          8) Upon submission it is agreed that the account details are correct
          and the company will transfer the amount to the account submitted.
        </li>
        <li class="m-1">
          9) The company won’t be liable if incase the details sent are wrong
          and won’t be able to entertain any issues thereafter.
        </li>
      </ul>
